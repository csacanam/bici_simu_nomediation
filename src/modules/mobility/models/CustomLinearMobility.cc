...
void CustomLinearMobility::move()
{
   ...
   else
   {
       ...
       }else{ //Actualiza velocidad de acuerdo a la aceleración del platoon para el resto de nodos

           currentSpeed += acceleration * elapsedTime;

           //    //Resetear la aceleracion
           //    if (acceleration != 0)
           //    {
           //        acceleration = 0;
           //    }

               //Si se resetea la aceleración, se está enviando información errónea a los vecinos
    ...
    EV << " " << logName() << "::" << getClassName() << " Accelaration= " << acceleration << endl;
