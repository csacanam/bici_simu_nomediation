...
void CustomRectangleMobility::move()
{
    ...
    EV << " " << logName() << "::" << getClassName() << " xpos= " << lastPosition.x << " ypos=" << lastPosition.y
            << " currentSpeed=" << currentSpeed << " accel=" << acceleration << endl;
    EV << " " << logName() << "::" << getClassName() << " previous Speed=" << previousSpeed << " elapsed = "
            << elapsedTime << endl;
}
